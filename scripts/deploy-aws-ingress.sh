...
echo "      # Grafana"
echo "      Usuário: admin"
echo "      Senha: kubectl get secret -n monitoring grafana-credentials -o jsonpath='{.data.admin-password}' | base64 -d"
echo ""
echo "      # Zabbix"
echo "      Usuário: Admin"
echo "      Senha: kubectl get secret -n monitoring zabbix-credentials -o jsonpath='{.data.admin-password}' | base64 -d"
echo ""
echo "════════════════════════════════════════════════════════"
echo ""
echo "📊 COMANDOS ÚTEIS:"
